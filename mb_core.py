#!/usr/bin/python3.6
# -*- coding: utf-8 -*-
# Code based on pylibmodbus by stephane <https://github.com/stephane/pylibmodbus/>
...
def cast_to_uint16(data):
    return int(ffi.cast('uint16_t', data))

def cast_to_uint32(data):
    return int(ffi.cast('uint32_t', data))
